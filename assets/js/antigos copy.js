...
async function carregarVeiculosAntigos() {
  const { data, error } = await supabaseClient
    .from("cars")
    .select("*")
    .eq("category", "antigo") // singular, conforme corrigimos
        ...
        <div class="card shadow-sm rounded-3 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="d-flex gap-2 mb-2">
              ...
              <span class="badge bg-light text-dark">${vehicle.brand}</span>
            </div>
            <h5 class="text-warning text-end">R$ ${vehicle.price.toLocaleString()}</h5>
